<template>
  <div>
    ...
    <hr />
    <div style="border: 50px solid blue; border-radius: 5px"></div>
    <hr />
    <div>
      <commands-data-table></commands-data-table>
    </div>
    <hr />
    <div style="border: 50px solid blue; border-radius: 5px"></div>
    <hr />
...
import CommandsDataTable from "@/components/CommandsDataTable.vue";
    ...
    getPlatformsData() {
      axios
        ...
        .then((response) => {
          ...
          this.tableHeader = "Platforms (Commands DB)";
